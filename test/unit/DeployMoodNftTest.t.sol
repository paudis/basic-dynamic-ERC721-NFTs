...
// Quick sanity check to only check that the DeployMoodNft script deploys MoodNFTs
...
contract DeployMoodNftTest is Test {
    ...
    function testConvertSvgToUri() public view {
        ...
        // cant compare string byte arrays - too long of a process
        // compare their  hashes using keccak256 :)
